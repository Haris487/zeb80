...
function tcvpb_follows_us_tc_shortcode( $attributes, $content = null  ) {
	...
	$return = '<a class="tcvpb_socialicon tcvpb_socialicon_facebook tcvpb_tooltip" data-gravity="'.esc_attr($gravity).'" href="'.esc_url($url).'" target="'.esc_attr($target).'" title="'.esc_attr($title).'"><i class="'.esc_attr($icon).'"></i></a>';
