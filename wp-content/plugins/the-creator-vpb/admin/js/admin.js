jQuery(document).ready(function($) {
    ...
    $("#wp-content-media-buttons").append('<a id="tcvpb_switch_button" class="button button-primary dashicons-before dashicons-schedule" title="'+tcvpb_from_WP.switch_button_activate+'">'+tcvpb_from_WP.switch_button_activate+'</a>');
    ...
    // ******************* elements *******************
        ...
        .on('mouseenter mouseleave', '.tcvpb_add_element', tcvpb_add_element_hover)
        .on('mouseenter mouseleave', '#tcvpb_elements_list li', tcvpb_popup_element_hover)
    ...
    // ******************* others *******************
        ...
        .on('click', '.upload_gallery_button', upload_gallery_button)
        ...
        .on('click', '#tcvpb_popup_close, #tcvpb_popup_backdrop', tcvpb_close_modal)
    ...
    *********************************************************************************************/
    ...
    function tcvpb_generate_main_html(){
        var tc_editor_html = '<div id="tcvpb_wrapper">'+
            '<div id="tcvpb_tools">'+
                '<a href="options-general.php?page=tcvpb" id="tcvpb_go_to_settings" title="'+tcvpb_from_WP.go_to_settings+'"><i class="pi-settings"></i></a>'+
                '<a href="#" id="tcvpb_switch_back_button"><i class="pi-switch"></i> '+tcvpb_from_WP.switch_button_deactivate+'</a>'+
                '<a href="#" id="tcvpb_fullscreen_button" class="tcvpb_right_buttons" title="'+tcvpb_from_WP.fullscreen+'"><i class="pi-fullscreen"></i></a>'+
                '<a href="#" id="tcvpb_layouts_button" class="tcvpb_right_buttons" title="'+tcvpb_from_WP.layouts+'"><i class="pi-layouts"></i></a>'+
                '<a href="#" id="tcvpb_redo_button" class="tcvpb_redo_button tcvpb_right_buttons disabled" title="'+tcvpb_from_WP.redo+'"><i class="pi-redo"></i></a>'+
                '<a href="#" id="tcvpb_undo_button" class="tcvpb_undo_button tcvpb_right_buttons disabled" title="'+tcvpb_from_WP.undo+'"><i class="pi-undo"></i></a>'+
            '</div>'+
        ...
        var tc_section_html = ''+
            '<div class="tcvpb_section_wrapper">'+
                '<div class="tcvpb_content_section" data-shortcode="'+shortcode+'">'+
                    '<div class="tcvpb_section_heading" title="'+tcvpb_from_WP.rearange_sections+'">'+
                        '<h4>'+title+'</h4>'+
                        '<span class="tcvpb_section_delete" title="'+tcvpb_from_WP.delete_section+'"><i class="pi-delete"></i></span>'+
                        '<span class="tcvpb_section_duplicate" title="'+tcvpb_from_WP.duplicate_section+'"><i class="pi-duplicate"></i></span>'+
                        '<span class="tcvpb_section_edit" title="'+tcvpb_from_WP.edit_section+'"><i class="pi-customize"></i></span>'+
                    '</div>'+
        ...
        var tcvpb_column_html = ''+
            '<div class="tcvpb_column'+column_empty+' colspan-'+span+'" data-span="'+span+'" data-shortcode="'+shortcode+'">'+
                ...
                '<div class="column_properties_baloon">'+
                    '<span class="tcvpb_move_column" title="'+tcvpb_from_WP.move_column+'"><i class="pi-move"></i></span>'+
                    '<span class="tcvpb_column_edit" title="'+tcvpb_from_WP.edit_column+'"><i class="pi-customize-alt"></i></span> '+
                    '<span class="tcvpb_remove_column" title="'+tcvpb_from_WP.remove_column+'"><i class="pi-delete"></i></span>'+
                    '<span class="tcvpb_add_column'+columns_add_disable+'" title="'+tcvpb_from_WP.add_column+'"><i class="pi-split"></i></span>'+
                    '<span class="tcvpb_add_column column_size">'+span+'/12</span>'+
                '</div>'+
            '</div>';
    ...
    function tcvpb_element_html(shortcode,title,excerpt){
        ...
        var tc_element_html = ''+
            '<div class="tcvpb_element" data-shortcode="'+shortcode+'">'+
                ...
                '</span>'+
                '<span class="tcvpb_element_delete" title="'+tcvpb_from_WP.delete_element+'"><i class="pi-delete"></i></span>'+
                '<span class="tcvpb_element_duplicate" title="'+tcvpb_from_WP.duplicate_element+'"><i class="pi-duplicate"></i></span>'+
                '<span class="tcvpb_element_edit" title="'+tcvpb_from_WP.edit_element+'"><i class="pi-edit"></i></span>'+
                '<span class="tcvpb_add_element"><span>'+tcvpb_from_WP.add_element+'</span></span>'+
            '</div>';
    ...
    function tcvpb_switch_button(e){
        ...
        if($('#tcvpb_tc_activated').is(':checked')){
            ...
            tcvpb_activate_dd('switch');
        }
    }

    function tcvpb_activate_dd(source){
    ...
    function tcvpb_generate_tcvpb_from_content(content,source){
        ...
        var section_handler_icons = '<span class="tcvpb_section_handler" title="Rearange Sections"></span><span class="tcvpb_section_delete" title="'+tcvpb_from_WP.delete_section+'"></span><span class="tcvpb_section_duplicate" title="'+tcvpb_from_WP.duplicate_section+'"></span><span class="tcvpb_section_edit" title="'+tcvpb_from_WP.edit_section+'"></span><span class="tcvpb_remove_column" title="'+tcvpb_from_WP.remove_column+'"></span><span class="tcvpb_add_column" title="'+tcvpb_from_WP.add_column+'"></span>';
        var element_handler_icon = '<span class="tcvpb_element_delete" title="'+tcvpb_from_WP.delete_element+'"></span><span class="tcvpb_element_duplicate" title="'+tcvpb_from_WP.duplicate_element+'"></span><span class="tcvpb_element_edit" title="'+tcvpb_from_WP.edit_element+'"></span>';
        ...
        if(initial_content!==''){
            var column_handler_icons= '<div class="column_properties_baloon"><span class="tcvpb_column_edit" title="'+tcvpb_from_WP.edit_column+'">'+tcvpb_from_WP.edit_column+'</span><span class="column_size">12/12</span></div>';
            no_of_sections++;

            var element_out = tcvpb_element_html('[text_dd]'+initial_content+'[/text_dd]','Text / HTML',initial_content);
            var column_out = tcvpb_column_html('[column_tc span=\'12\']','12',element_out);
            output += tcvpb_section_html('[section_tc]','',section_content,1);
        }
    ...
    function tcvpb_section_edit(e) {
        ...
        var button_out = '<a href="#" class="button-primary" id="tcvpb_save_section_settings">Update Section Properties</a>';
        
        tcvpb_open_element_modal('Section Properties','edit_section',modal_content,e.clientX,e.clientY,'');
    }
    ...
    function tcvpb_column_edit(e) {
        ...
        var edit_data = wp.shortcode.next( shortcode, selected_content );
        var modal_content = tcvpb_modal_content(shortcode, edit_data);
        var button_out = '<a href="#" class="button-primary" id="tcvpb_save_column_settings">Update Column Properties</a>';

        tcvpb_open_element_modal('Column Properties','edit_column',modal_content,e.clientX,e.clientY,'');
    }
        ...
        var popup_html = ((action=='edit') ? '<div id="tcvpb_popup" class="tcvpb_modal_'+action+'">' : '')+
            '<div id="tcvpb_popup_window_element"'+position+'>'+
                ...
                '<div id="tcvpb_popup_element_footer">'+
                    ((action=='new') ? '<a href="#" id="tcvpb_popup_back_to_list"><i class="pi-undo"></i>Back to list</a>' : '')+
                    ((child!='')?'<a href="#" id="tcvpb_collapse_children" title="Collapse and Sort Child Elements"><i class="pi-collapse"></i></a>':'')+
                    '<a href="#" id="'+button_id+'"><i class="pi-done"></i></a>'+
                    '<a href="#" id="tcvpb_popup_close"><i class="pi-abort"></i></a>'+
                '</div>'+
            '</div>'+
    ...
    function tcvpb_open_layout_modal(){
        var popup_html ='<div id="tcvpb_popup" class="">'+
            '<div id="tcvpb_popup_window_select">'+
                ...
                '</div>'+
                '<div id="tcvpb_popup_element_footer">'+
                    '<input type="text" id="tcvpb_layout_save_input" placeholder="New Layout">'+
                    '<a href="#" id="tcvpb_popup_layout_save"><i class="pi-save"></i></a>'+
                '</div>'+
            '</div>'+
            '<div id="tcvpb_popup_backdrop"></div>'+
        '</div>';
        ...
        $.post(ajaxurl, data, function(response) {
            ...
            $.each(layouts,function(index,val){
            	layouts_out += '<div class="tcvpb_popup_layout_content">'+
                    '<span>'+val+'</span>'+
                    '<a class="tcvpb_layout_content_delete">Delete</a>'+
                    '<a class="tcvpb_layout_content_overwrite">Overwrite</a>'+
                '</div>';
            });
    ...
    function tcvpb_add_element_hover(){
        $(this).parent().toggleClass('not_hovered');
    }
    ...
    function tcvpb_attribute_fields(attribute_name, attribute, value){
        ...
        switch (attribute.type) {
            ...
            case "gallery":
                ...
                attribute_fields += '<input type="button" value="Upload Gallery" class="button upload_gallery_button">';
            break;
            case "image":
                attribute_fields += '<div class="image_upload_image">'+((set_value!='')?'<img src="'+set_value+'">':'')+'</div>';
                attribute_fields += '<input type="text" name="'+attribute_name+'" value="'+set_value+'" id="tcvpb_shortcode_attribute_'+attribute_name+'" class="tcvpb_shortcode_attribute">';
                attribute_fields += '<input type="button" value="Upload Image" class="button upload_image_button">';
                attribute_fields += '<span class="tcvpb_image_delete'+((set_value=='')?' display_none':'')+'" title="Delete Image"><i class="pi-delete"></i></span>';
            break;
            case "media":
                attribute_fields += '<input type="text" name="'+attribute_name+'" value="'+set_value+'" id="tcvpb_shortcode_attribute_'+attribute_name+'" class="tcvpb_shortcode_attribute">';
                attribute_fields += '<input type="button" value="Upload Media" class="button upload_image_button">';
            break;
            case "padding":
                attribute_fields += '<div class="tcvpb-cross-wrapper">';
                    ...
                    attribute_fields += '<div class="tcvpb-cross-margin">';
                        attribute_fields += '<span>margin</span>';
                        attribute_fields += '<input type="text" value="" placeholder="-" data-prop="margin-top" class="tcvpb_cross_field tcvpb-margin-top">';
                        attribute_fields += '<input type="text" value="" placeholder="-" data-prop="margin-right" class="tcvpb_cross_field tcvpb-margin-right">';
                        attribute_fields += '<input type="text" value="" placeholder="-" data-prop="margin-bottom" class="tcvpb_cross_field tcvpb-margin-bottom">';
                        attribute_fields += '<input type="text" value="" placeholder="-" data-prop="margin-left" class="tcvpb_cross_field tcvpb-margin-left">';
                    attribute_fields += '</div>';
                    attribute_fields += '<div class="tcvpb-cross-border">';
                        attribute_fields += '<span>border</span>';
                    ...
                    attribute_fields += '<div class="tcvpb-cross-padding">';
                        attribute_fields += '<span>padding</span>';
    ...
    function tcvpb_modal_content(selected_element, edit_data){
        ...
        if(action_value=='new' && elements[selected_element].child!==undefined){
            attributes_table_content += '<div class="tcvpb_children_wrapper">';
                ...
                var child_name = elements[selected_element].child;
                    ...
                    var button_text = (elements[selected_element].child_button != undefined) ? elements[selected_element].child_button : 'Add Child';
                    attributes_table_content += '<a href="#" class="button-primary tcvpb_add_child">'+button_text+'</a>';
                    attributes_table_content += '</div>';
                        ...
                        if(typeof current_element !== 'undefined'){
                            ...
                            if(element_name!=='[last_tcvpb_limit]'){
                                ...
                                if(elements[child_name].content!==undefined){
                                    ...
                                    attributes_table_content += '<label for="tcvpb_child_content">'+elements[child_name].content.description+'</label>';
                                    attributes_table_content += '<textarea name="tcvpb_child_content" class="tcvpb_child_content textarea_tinymce">'+child_content_out+'</textarea>';
                                }
        ...
        //if element has content
            ...
            attributes_table_content += '<textarea name="tcvpb_element_content" class="tcvpb_element_content textarea_tinymce">'+content_value+'</textarea>';
            attributes_table_content += '</div>';
        }
    ...
    function tcvpb_popup_back_to_list(){
        $('#tcvpb_popup_window_element').remove();
        $('#tcvpb_popup_window_select').show();
        $('#tcvpb_element_selector_filter').focus();
    }

    function tcvpb_popup_element_hover(){
        var hover_html = '<h2>'+elements[$(this).data('element')].name+'</h2>'+elements[$(this).data('element')].description;
        $('#tcvpb_popup_content_sidebar').html(hover_html);
    }
    ...
    function tcvpb_insert_element(e) {
        ...
        $('.tcvpb_child').each(function() {
            ...
            output += ']';
            output += (($(this).find('.tcvpb_child_content').val()!==undefined) ? $(this).find('.tcvpb_child_content').val().replace(/'/g, '&rsquo;') : '') + '[/' + tcvpb_shortcode_child_name + ']';
            count_children++;
        });
        // content and wrap shortcode
        if (count_children === 0){
            var tcvpb_element_content = (($('.tcvpb_element_content').val()!==undefined) ? $('.tcvpb_element_content').val().replace(/'/g, '&rsquo;') : '') + '[/' + selected_shortcode + ']';
    ...
    function tcvpb_add_child(e) {
        ...
        var $new_child = $after_child.clone().hide().insertAfter($after_child).slideDown(800);
        var $inserted_title_number = $new_child.find('.tcvpb_child_title .number');
    ...
    function tcvpb_cross(e) {
        ...
        $input_fields.each(function(){
            var $field = $(this);
            if($field.val()!=''){
                output += $field.data('prop')+':'+$field.val()+'px;';
            }
        });
        $hidden_field.val(output);
    }
