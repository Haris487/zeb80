...
// if(is_dir(get_stylesheet_directory().'/the-creator-vpb')){
// 	$tcvpb_theme_override = scandir(get_stylesheet_directory().'/the-creator-vpb');
// }
...
/* Include elements form plugin or theme (if overridden) */


/* Include supported_plugins shortcode definitions */

/* Include theme's additional shortcodes */
// if(is_dir(get_stylesheet_directory().'/the-creator-vpb/additional')){
// 	$files = scandir(get_stylesheet_directory() . '/the-creator-vpb/additional');
// 	foreach($files as $file) {
// 		if(is_file(get_stylesheet_directory() . '/the-creator-vpb/additional/'.$file)){
// 	  		include_once (get_stylesheet_directory() . '/the-creator-vpb/additional/'.$file);
// 		}
// 	}
// }
