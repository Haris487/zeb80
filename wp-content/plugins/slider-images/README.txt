...
Slider - Images WordPress Plugin
...
Watch Below Video For Image Slider
...
Slider Image makes displaying your gallery of images a beautiful experience, by using amazing slideshow effects ranging from slicing and sliding to fading and folding. There simply is no better way to showcase your amazing work than to make the presentation of it looks just as beautiful.
...
Slider has many benefits. You can replace images how you want, by Drag & Drop. Using the mouse you can replace images, titles and descriptions.
...
Let you to choose which slider shape fit to your site. Currently 9 different slider types and 50+ slide effects included.
...
* [Thumbnails Slider & Lightbox](ttp://rich-web.esy.es/wordpress-slider-image-thumbnail-slider-lightbox/)
...
Your WordPress web-site represents you, your brand or your company. Rich Slider-image allows you to create your plugin, exactly as you would like. Selection and settings of color, background, borders and edges, and more.
...
Cross Browser - Tested in major desktop, tablet, and mobile browsers and fully featured in Firefox, Chrome, Safari, Opera, and Internet Explorer 10+. With support for Internet Explorer 8 & 9 via a fallback theme; a traditional side-to-side slider.
...
* [Slider Images Pro](http://rich-web.esy.es/slider-image)
...
* [Thumbnails Slider & Lightbox](http://rich-web.esy.es/wordpress-slider-image-thumbnail-slider-lightbox)
* [Thumbnails Slider & Lightbox 2](http://rich-web.esy.es/wordpress-slider-image-thumbnail-slider-lightbox-2)
...
Click to add new button -> Search plugins. On empty line write your preferable plugin. [Example slider image](http://rich-web.esy.es/slider-image/). Your preferable **photo slider** plugin you can find from WordPress large menu.
...
Watch Below Video For Slider Image Free Version
...
Clicking **Install Now**, already you can start installation process of the slider image plugin.
...
Watch Below Video For Slider Image Pro Version
...
= I bought Slider image plugin, I have not received it yet. Please suggest, how can I activate it or get the Pro version? =
...
1.  Download Slider Image Pro version. If You still see the old version press Ctrl+F5 for refresh the page.
...
1.  Click to add new button -> Search plugins. On empty line write your preferable plugin. Example slider. Your preferable WordPress slider image plugin you can find from WordPress large menu.
...
1.  Clicking on the Zip file, if You have a plugin in a Zip format, you may install it by uploading it here. If You have not received the Slider-Image Zip file, please contact with our support team.

1.  Clicking " Install Now", already you can start installation process of the WordPress plugin.

1.  When will finished the installation process, you can activate it or not. By activating, already Your slider-image will be ready. You can change parameter in the General Options.
...
18. Dynamic Slider
19. Dynamic Slider
20. Thumbnails & Lightbox
21. Thumbnails & Lightbox
22. Slider Accordion
23. Slider Accordion
...
If You think You have found a mistake in the Slider Images or have any problem, questions about the plugin, please read the support forum on our WordPress website. If You can not find a solution here, please feel free and click here to contact us. " richweb.org@gmail.com "

### Rich Web

* [WordPress Slider Images Pro](http://rich-web.esy.es/slider-image)
...
Text Align." Left, Right & Center ". Determine the alignment of the slide names.
...
Hover effect. " 4 types Slide Out, Flip Out, Double Flip Out & Both Ways " Select the desired effect from the list. There is an effect, which displays the image or only the title without the image.
...
Position. " Bottom & Top " Select the position where you want to insert the navigation on the top or at the bottom.
...
Text Align. " Left, Right & Center " Select the text position for the image header.
...
Description Text Align. " Left, Right & Center " Select the text position for the description.

Settings for Image

Show Image. " Left, Right & Center " Choose to show the image in the slider or not. You can make the slider with name and with description without image.
...
Link Button position. " Left, Right & Center " Choose the position for the link button.
...
Animation Type. " fade & slide " Choose your preferable animation effect for slider.
...
Text Align. " Left, Right & Center " Select the description text position.
...
Text Align. " Left, Right & Center " Select the text position of the title.
...
Border Style. " None, Solid, Dashed & Dotted " Select the border style for the button in the oving image.
...
Position. " Bottom & Top " Select where to place the title and description text in slider container.
...
Show Arrow Text. " Yes " " No "
Left Arrow Text. " Your Text "
...
Background color. " RGB # color number "
...
Position. " Left, Right & Center " Select the position for the current image.
...
Toggle Arrows. " Yes " " No " If true, side navigation arrows will slide out on hovering & hide other times.
Autoplay. Delay between transitions in ms. If this parameter is not specified, autoplay will be disabled.
...
Overlay Color for LiightBox. " RGB or # Color number " Select a overlay color for the lightbox.
LiightBox Border Width. " from 0 to 15 pixel " Change the border width of lightbox.
LiightBox Border style. " None, Solid, Dashed, Dotted " Change the border style of lightbox.
Border Color for LiightBox. " RGB or # Color number " Change the border style of lightbox.
Border Radius. " from 0 to 100 pixel " Choose the radius border.
Content Background for LiightBox. " RGB or # Color number " Choose the content background for the lightbox.
...
= Image Slider is an innovative, responsive WordPress Slider plugin that displays your content the beautiful way. =