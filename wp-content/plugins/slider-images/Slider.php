<?php
	/*
		...
		Plugin URI: https://www.rich-web.esy.es/slider-image
	...
	*/
	...
	{
		add_menu_page('Rich-Web Slider Admin','Photo Slider','manage_options','Rich-Web Slider Admin','Manage_Rich_Web_Slider_Admin',plugins_url('/Images/admin.png',__FILE__));
 		add_submenu_page( 'Rich-Web Slider Admin', 'Rich-Web Slider Admin', 'Slider Manager', 'manage_options', 'Rich-Web Slider Admin', 'Manage_Rich_Web_Slider_Admin');
		add_submenu_page( 'Rich-Web Slider Admin', 'Rich-Web Slider General', 'Slider Options', 'manage_options', 'Rich-Web Slider General', 'Manage_Rich_Web_Slider_General');
		add_submenu_page( 'Rich-Web Slider Admin', 'Rich-Web Slider Products', 'Our Products', 'manage_options', 'Rich-Web Slider Products', 'Manage_Rich_Web_Slider_Products');
	}
